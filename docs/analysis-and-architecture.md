...
- **TypeScript** (recomendado — contratos claros para services y modelos; el reviewer lo valora). _Confirmar con el usuario si prefiere JS._
...
interface BettingService {
  placeBet(o: BetOrder): Promise<BetReceipt>
}
